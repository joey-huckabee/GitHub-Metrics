...
| L3-TRU-002 | L2-TRU-001 | `tests/test_trusted_orgs.py::test_a_registry_folds_the_case_of_keys_it_is_given`<br>`tests/test_trusted_orgs.py::test_matching_ignores_case_and_padding`<br>`tests/test_trusted_orgs.py::test_the_check_is_logged` | Implemented |
